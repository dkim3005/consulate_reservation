...
QUOTE_PROMPT = (
    "민원 창구에서 하루 종일 사람을 응대하는 직원들이 점심시간에 읽을, "
    "마음에 와닿는 응원의 한마디를 직접 지으세요. "
    "그들의 보이지 않는 수고를 알아주고 공감하는, 따뜻하고 진심 어린 문장이어야 합니다. "
    "한국어 한두 문장, 70자 이내. "
    "명언 인용이나 인물명 표기 금지, 이모지 금지, "
    "상투적 표현('힘내세요' 등)과 임의 서명('동료일동' 등) 금지. 문장만 출력하세요."
)
QUOTE_FALLBACKS = [
    "오늘도 누군가의 하루를 편하게 만들어 주셨습니다. 그 수고를 알고 있습니다.",
    "창구 너머의 한 사람에게는, 오늘 당신이 가장 큰 도움이었습니다.",
    "반복되는 하루 같아도, 당신이 처리한 일 하나하나가 누군가에게는 큰 일이었습니다.",
    "친절은 기억에 오래 남습니다. 오늘 그 기억을 만들어 주셨습니다.",
    "오전의 수고가 오후의 여유로 돌아오기를 바랍니다.",
]
