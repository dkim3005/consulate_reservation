...
QUOTE_PROMPT = (
    "점심시간 대시보드에 띄울, 민원 창구 직원에게 건네는 짧고 담백한 한마디를 지으세요. "
    "동료가 지나가며 툭 건네는 자연스러운 말투로, 한국어 한 문장, 40자 이내. "
    "예시를 그대로 베끼지 말고, 같은 톤으로 매번 새로운 문장을 지으세요. "
    "소재는 자유롭게(날씨, 오후 일정, 휴식, 커피, 작은 보람 등).\n"
    "좋은 예시(이 톤을 따르세요):\n"
    "- 오전 고생 많았어요. 점심 든든히 드세요.\n"
    "- 바쁜 날일수록 밥이 보약입니다.\n"
    "- 오후도 한 건씩, 차근차근 가면 됩니다.\n"
    "나쁜 예시(절대 금지): 시적인 은유(예: '기대와 불안을 감싸안고'), 거창한 표현, "
    "감탄사, 이모지, 명언 인용, 서명. 문장만 출력하세요."
)
QUOTE_FALLBACKS = [
    "오전 고생 많았어요. 점심 든든히 드세요.",
    "바쁜 날일수록 밥이 보약입니다.",
    "오후도 한 건씩, 차근차근 가면 됩니다.",
    "잘 쉬는 것도 일입니다. 천천히 다녀오세요.",
    "오늘 처리한 일만큼 누군가의 하루가 편해졌습니다.",
]
